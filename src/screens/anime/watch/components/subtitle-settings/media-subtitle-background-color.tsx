...
import { subtitleBackgroundColor } from '../../store';
...
const MediaSubtitleBackgroundColor = () => {
        ...
        <View className="flex flex-row items-center justify-between">
          <View className="flex flex-row items-center px-4 py-2">
            ...
            <Text variant="lg" className="ml-4 text-gray-300">
              {colors.find((color) => color.value === backgroundColor)?.label}
            </Text>
          </View>
        </View>
      </Tappable>
...
export default MediaSubtitleBackgroundColor;
