...
const BUNDLE_ID = 'com.hoangvu12.kaguya'; // ios bundle id
const PACKAGE = 'com.hoangvu12.kaguya'; // android package name
const NAME = 'Kaguya'; // app name
const EXPO_ACCOUNT_OWNER = 'hoangvu12'; // expo account owner
...
const client = z.object({
  APP_ENV: z.enum(['development', 'alpha', 'production']),
  NAME: z.string(),
  BUNDLE_ID: z.string(),
  PACKAGE: z.string(),
  VERSION: z.string(),
